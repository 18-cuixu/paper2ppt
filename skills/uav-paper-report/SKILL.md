...
- If `scan_rendered_slides.py` warns about high blank fraction, large top/bottom blank, or large internal horizontal whitespace, the slide must be rerendered after a layout change. Do not silence the warning by loosening thresholds unless the slide is a cover/thanks page.
